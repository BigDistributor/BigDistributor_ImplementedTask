 ...
 * #L%
 */
package com.bigdistributor.tasks.deconvolution.v2;
...
public class HeadlessDeconvolution
{
    public static void main( String[] args ) throws SpimDataException
    {
        ...
        // load drosophila
        SpimData2 spimData = new XmlIoSpimData2( "" ).load( "/Users/Marwan/Downloads/drosophila_his-yfp/dataset.xml" );
