 ...
 */
public class ImageDeconvolution  {
...
//        List<TimePoint> timespoint = new ArrayList<>(spimdata.getSequenceDescription().getTimePoints().getTimePointsOrdered());
//        SpimData2.getAllViewIdsSorted(spimdata, viewSetups, timespoint)
        deconvolve(spimdata, views);
    }
    ...
    public static void main(String[] args) throws SpimDataException {
        ImageDeconvolution.defaultXMLfilename = "/Users/Marwan/Downloads/drosophila_his-yfp/dataset.xml";
        new ImageDeconvolution().run();
    }
}
